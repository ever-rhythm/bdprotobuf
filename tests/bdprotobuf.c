...
PHP_INI_BEGIN()
    STD_PHP_INI_ENTRY("bdprotobuf.global_value",      "42", PHP_INI_ALL, OnUpdateLong, global_value, zend_bdprotobuf_globals, bdprotobuf_globals)
    STD_PHP_INI_ENTRY("bdprotobuf.global_string", "foobar", PHP_INI_ALL, OnUpdateString, global_string, zend_bdprotobuf_globals, bdprotobuf_globals)
PHP_INI_END()
*/
/* }}} */
